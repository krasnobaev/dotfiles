...
static const char *webhcmd[]  = { "chromium-browser", "--incognito", NULL };
...
static const char *topcmd[] = { "gnome-terminal", "--command=top", "--hide-menubar", NULL};
...
//	{ 0,               XK_c,       spawn, {0} },
	...
	{ MODKEY|ControlMask, XK_e,    spawn, {.v = explorercmd } },
